...
export const MarkedRaceDescriptions = {
  anthozoan: {
    label: "Anthozoan",
    img: "systems/tales-of-mezoria-system/assets/races/anthozoan.webp",
    description: `
<h2>Anthozoan</h2>
...
their people are inseparable.
  ...
  human: {
    label: "Human",
    img: "systems/tales-of-mezoria-system/assets/races/human.webp",
    description: `
<h2>Human</h2>
...
Faith—whether devoted or doubtful—is woven into the core of the human experience.
  ...
  etherean: {
    label: "Etherean",
    img: "systems/tales-of-mezoria-system/assets/races/etherean.webp",
    description: `
  ...
  mythrian: {
    label: "Mythrian",
    img: "systems/tales-of-mezoria-system/assets/races/mythrian.webp",
    description: `
<h2>Mythrian</h2>
...
keepers of ancient primal wisdom.
  ...
  sylvan: {
    label: "Sylvan",
    img: "systems/tales-of-mezoria-system/assets/races/sylvan.webp",
    description: `
<h2>Sylvan</h2>
...
who trespass against it.
  ...
  sprite: {
    label: "Sprite",
    img: "systems/tales-of-mezoria-system/assets/races/sprite.webp",
    description: `
<h2>Sprite</h2>
...
<strong>to see something new.</strong>
  ...
  auramine: {
    label: "Auramine",
    img: "systems/tales-of-mezoria-system/assets/races/auramine.webp",
    description: `
<h2>Auramine</h2>
...
is both a work of art and a conduit of their connection to the celestial realms.
  ...
  draconian: {
    label: "Draconian",
    img: "systems/tales-of-mezoria-system/assets/races/draconian.webp",
    description: `
<h2>Draconian</h2>
...
their wisdom shapes the political, martial, and cultural fabric of the world.
  ...
  embergiest: {
    label: "Embergeist",
    img: "systems/tales-of-mezoria-system/assets/races/embergeist.webp",
    description: `
<h2>Embergeist</h2>
...
artisanship with philosophy, creating a culture where creation and identity are deeply intertwined.
  ...
  earthen: {
    label: "Earthen",
    img: "systems/tales-of-mezoria-system/assets/races/earthen.webp",
    description: `
<h2>Earthen</h2>
...
the foundations—literally and culturally—of civilizations throughout Mezoria.
  ...
  prismatic: {
    label: "Prismatic",
    img: "systems/tales-of-mezoria-system/assets/races/prismatic.webp",
    description: `
<h2>Prismatic</h2>
